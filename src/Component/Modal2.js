...
function Modal2({addButton, addPracticeHandler, addTimeHandler, handleButtonClick}) {
          ...
          <ModalBackdrop onClick={openModalHandler}>
            <ModalView onClick={e => e.stopPropagation()}>
              ...
              <Section>
                <Modaltext
                  placeholder=" 연습내용"
                  onChange={inputContentHandler}></Modaltext>
                <TimeInput
                  type="number"
                  min="10"
                  max="60"
              ...
              <AddButton onClick={buttonClick}>추가</AddButton>
            </ModalView>
          </ModalBackdrop>
        ) : null}
      </Maincontainer>
